...
<br>&emsp;The 'key' value is presented as an key in the message to identify the value you want to see.
<br>&emsp;The 'value' is presented to visualize what is saved inside the variable.
### • log(Exception e)
&emsp;<b>→ Obs:</b> 
<br>&emsp;<b>→ Screen shoot:
<br>&emsp;
